...
class CommonAdapter<T> : RecyclerView.Adapter<BusinessHolder<T>>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BusinessHolder<T> {
        val businessHolder = mItemViewTypeMap.get(viewType)
        businessHolder?.let {
    ...
    override fun onBindViewHolder(holder: BusinessHolder<T>, position: Int) {
